...
\clearpage
\subsection{\method{void}{addOptionCheckbox}{string name}{string description}{bool default}}
...
\clearpage
\subsection{\method{void}{addOptionNumber}{string name}{string description}{float default}}
\subsubsection{Parameters}
\begin{center}
\begin{tabular}{by}
	|name| & Variable name for accessing value later.\\
...
\clearpage
\subsection{\method{dict}{ttest}{list values1, list values2, bool eqvar}}
\subsubsection{Parameters}
\begin{table}[h]
\begin{center}
\begin{tabular}{by}
